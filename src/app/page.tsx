  ...
  return (
    <div className="space-y-8">
      <section className="relative -mx-4 -mt-6 min-h-[calc(100vh-88px)] overflow-hidden border-b border-cyan/20 bg-black sm:rounded-b-[2rem]">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,4,16,0.16)_0%,rgba(0,4,16,0.24)_45%,rgba(0,4,16,0.92)_100%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_54%,rgba(1,208,251,0.12),transparent_31rem)]" />
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-88px)] max-w-7xl flex-col justify-end px-4 pb-6 pt-28 sm:px-6 lg:px-8">
          <div className="grid items-end gap-6 lg:grid-cols-[1fr_360px]">
            <div className="max-w-4xl">
              <div className="mb-3 text-xs font-black uppercase tracking-[0.34em] interclub-blue-text">
                One island. {campaignClubCount} clubs. 1 identity.
              </div>
              <h1 className="interclub-title text-5xl font-black uppercase leading-none sm:text-7xl lg:text-8xl">
                Interclub 2026
              </h1>
              <p className="mt-4 max-w-2xl text-base font-bold uppercase tracking-[0.18em] text-cyan sm:text-lg">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <Link href="/teams" className="inline-flex items-center gap-2 rounded-md border border-cyan/50 bg-black/35 px-4 py-3 text-sm font-bold uppercase text-cyan backdrop-blur transition hover:bg-cyan/10">
                  <Users size={17}/> Equipes
                </Link>
                <Link href="/admin/rankings" className="inline-flex items-center gap-2 rounded-md border border-white/20 bg-black/35 px-4 py-3 text-sm font-bold uppercase text-white backdrop-blur transition hover:border-cyan/60 hover:text-cyan">
          ...
          <div className="mt-8 grid grid-cols-2 gap-2 sm:grid-cols-4">
            <div className="border-t border-cyan/35 bg-black/35 p-3 backdrop-blur">
